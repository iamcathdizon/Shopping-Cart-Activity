<?php
    $arrProducts = array(
        array(
            ...
            'price'         => "550",
            'photo1'        => "black-dressA.png",
            'photo2'        => "black-dressB.png"
        ),
        array(
            ...
            'price'         => "550",
            'photo1'        => "checkered-dressA.png",
            'photo2'        => "checkered-dressB.png",
        ),
        array(
            ...
            'price'         => "750",
            'photo1'        => "dress-floralA.png",
            'photo2'        => "dress-floralB.png",
        ),
        array(
            ...
            'price'         => "600",
            'photo1'        => "green_dress1.1-removebg-preview.png",
            'photo2'        => "green_dress1-removebg-preview.png",
        ),
        array(
            'name'          => "Mint Puff Dress",
            ...
            'price'         => "800",
            'photo1'        => "mint-dressA.png",
            'photo2'        => "mint-dressB.png",
        ),
        array(
            'name'          => "Dress with Slit",
            ...
            'price'         => "800",
            'photo1'        => "white-dress-slit A.png",
            'photo2'        => "white-dress-slit B.png",
        ),
        array(
            'name'          => "Orange Floral Dress",
            ...
            'price'         => "750",
            'photo1'        => "orange-dressA.png",
            'photo2'        => "orange-dressB.png",
        ), 
        array(
            ...
            'price'         => "650",
            'photo1'        => "white-dressA.png",
            'photo2'        => "white-dressB.png",
        )
    );
?>